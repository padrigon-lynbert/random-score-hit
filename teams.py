...
while True:
    ...
    if score_to == "Red":
        try:
            red.append(hit); RED.append(sum(red)+hit); BLUE.append(BLUE[-1])
        except IndexError: BLUE.append(0)
        ...
        try:
            blue.append(hit); BLUE.append(sum(blue)+hit); RED.append(RED[-1])
        except IndexError: RED.append(0)
...
print("MATCH INFO")
# ave = round(mean([3, 5, 4, 5, 4, 3, 5, 3, 3, 3, 3, 3, 4, 5]),1)
...
plt.text(0, BLUE[0], sum(blue), fontsize=12, color='blue', ha='left', va='bottom')
